...
public class AssignedJobOrder extends DroppableMachineEvent implements Serializable, MachineEvent {
    ...
    public boolean mergeableWith(MachineEvent e) {
        if(e instanceof AssignedJobOrder) {
            AssignedJobOrder aj = (AssignedJobOrder)e;
            return !aj.equals(this) && aj.getMachine().equals(getMachine()) &&
                   aj.getJobOrder().equals(getJobOrder());
        }
        return false;
    }
