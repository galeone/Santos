...
import it.galeone_dev.santos.hibernate.abstractions.DroppableGlobalEvent;
...
public class WorkingDay extends DroppableGlobalEvent implements Serializable, GlobalEvent {
    ...
    public String color = "#afafaf", type = "workingday";
    ...
    public String toString() {
        return "WorkingDay [id=" + id + ", start=" + start + ", end=" + end + ", title=" + title + ", color=" + color + "]";
    }
